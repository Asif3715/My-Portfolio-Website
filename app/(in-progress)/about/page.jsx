      ...
      <main className='container mx-auto px-6 py-20'>
        ...
        <section className='mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div>
              <h3 className='text-xl font-medium mb-2'>ML / DL</h3>
              <p>PyTorch, TensorFlow, Scikit-learn, HuggingFace Transformers, spaCy</p>
            </div>
            <div>
              <h3 className='text-xl font-medium mb-2'>LLMs & NLP</h3>
              <p>LangChain, OpenRouter API, RAG, Prompt Engineering</p>
            </div>
            <div>
              <h3 className='text-xl font-medium mb-2'>Data & BI</h3>
              <p>Pandas, NumPy, Matplotlib, Power BI, DAX, EDA</p>
            </div>
            <div>
              <h3 className='text-xl font-medium mb-2'>Web & Backend</h3>
            ...
            <div>
              <h3 className='text-xl font-medium mb-2'>Tools & Platforms</h3>
